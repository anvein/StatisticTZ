...
public final class StatisticsModel {
    ...
    public var visitorsByPeriodFilter: VisitorsStatisticPeriod = .byDay

    // MARK: - Data / Bindings

    private let isLoadingSubject: BehaviorSubject<Bool> = .init(value: false)
    public var isLoadingObservable: Observable<Bool> { return isLoadingSubject.asObservable() }

    private let visitorsByPeriodsSubject = BehaviorSubject<VisitorsByPeriodsModelDto>(
        value: .init(countByPeriods: [], period: .byDay)
    )
    public var visitorsByPeriodsObservable: Observable<VisitorsByPeriodsModelDto> {
    ...
    public var visitorsTrendSubjectObservable: Observable<VisitorsTrendModelDto> {
        return visitorsTrendSubject.asObservable()
    }

    private let topVisitorsSubject = BehaviorSubject<[TopVisitorModelDto]>(value: [])
    public var topVisitorsObservable: Observable<[TopVisitorModelDto]> { return topVisitorsSubject.asObservable() }

    private let subscriptionsTrendSubject = BehaviorSubject<ObserversTrendModelDto>(value: .init())
    public var subscriptionsTrendSubjectObservable: Observable<ObserversTrendModelDto> {
    ...
    public var unsubscriptionsTrendSubjectObservable: Observable<ObserversTrendModelDto> {
    ...
    public func loadData(forceReload: Bool = false) async {
    ...
    public func reloadVisitorsByPeriodsData() {
